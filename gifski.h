...
#define ABORTED GIFSKI_ABORTED
  ...
  /** Allows setting a custom background color for semitransparent pixels.
   *
   * This helps to make the edges smoother for when a transparent gif needs to blend against
